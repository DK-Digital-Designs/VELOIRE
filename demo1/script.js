...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll("[data-rfa-form]").forEach(form => {
        form.addEventListener("submit", event => {
            ...
            alert("Thank you. Your Request for Access has been captured for manual review.\n\n(This is a front-end demo only.)");
            form.reset();
        });
    });
    ...
    if (ownerForm) {
        ownerForm.addEventListener("submit", event => {
            event.preventDefault();
            alert("Thank you. A member of the Veloire team will contact you regarding your partnership enquiry.\n\n(Demo only.)");
            ownerForm.reset();
        });
    }
    ...
    if (newsletterForm) {
        newsletterForm.addEventListener("submit", event => {
            event.preventDefault();
            alert("Thank you. Your email has been added to the private early access list.\n\n(Demo only.)");
